...
def dataset_states_to_obs(args):
    ...
    env_meta['env_kwargs']['use_depth_obs'] = args.camera_depths
    ...
    for i in range(0, len(demos), num_workers):
        ...
        for j in range(i, end):
            ...
            if is_robosuite_env:
                ...
                # # change camera position and fov to simu;ate fisheye lens
                # initial_state['model'] = initial_state['model'].replace('pos="0.05 0 0" quat="0 0.707107 0.707107 0" fovy="75"',
                                                        # 'pos="0.06 0 0.03" quat="0 0.707108 0.707108 0" fovy="130"')
