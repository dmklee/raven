...
from uferl.envs.vec_env import VecEnv, CloudpickleWrapper
...
class SubprocVecEnv(VecEnv):
    ...
    def step_async(self, actions, dummy_reward=False):
        for remote, action in zip(self.remotes, actions):
            remote.send(("step", (action, dummy_reward)))
        self.waiting = True
    ...
    def get(self, attr_name):
        return self.get_attr(attr_name, [0])[0]

    def has_attr(self, attr_name):
        self.remotes[0].send(("has_attr", attr_name))
